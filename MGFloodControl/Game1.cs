...
namespace MGFloodControl
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            playingPieces = this.Content.Load<Texture2D>("Texture/Tile_Sheet");
            backgroundScreen = this.Content.Load<Texture2D>("Texture/Background");
            titleScreen = this.Content.Load<Texture2D>("Texture/TitleScreen");
        }
